...
def mocks():
    ...
    def chart_url(rel_path):
        ...
        the chart doesn't exist yet. Same fix as the dashboard: without
        this the browser keeps showing the chart from the previous mock
        test instead of the freshly redrawn one."""
