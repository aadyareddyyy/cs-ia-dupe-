...
static/charts/          Auto-generated PNG charts (score trend)
...
- **Mock tests**: for every section you now enter *correct*, *incorrect*,
  ...
  incorrect / not attempted with percentages, and a score trend line
  chart. The latest mock score and percentage also show on the Dashboard.
...
- Line chart (score trend) and pie chart (correct / incorrect / not attempted)
